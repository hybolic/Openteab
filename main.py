...
def launch_app(api_class, tracker: Optional[BiomeTracker] = None) -> BiomeTracker:
    ...
    try:
        ...
        try:
            api.set_window(webview.create_window(title=f"Openteab Macro {current_version}",url=url,js_api=api,width=950,height=550,min_size=(550, 500),resizable=True,frameless=False))
