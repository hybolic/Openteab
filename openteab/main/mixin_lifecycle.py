...
class LifecycleMixin:
    def __init__(self):
        ...
        self.disabled_biomes_br_sc_var = ConfigVar(self.config, "disabled_biomes_br_sc", [])
        ...
        self.fishing_ui_nav_close_var   = ConfigVar(self.config, "fishing_ui_nav_close", False)
        ...
        self.enable_jester_exchange_var = ConfigVar(self.config, "enable_jester_exchange", False)
        self.jester_exchange_threshold_var = ConfigVar(self.config, "jester_exchange_threshold", "3")
